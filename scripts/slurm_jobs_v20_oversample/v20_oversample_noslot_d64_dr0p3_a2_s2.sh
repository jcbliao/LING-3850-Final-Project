#!/bin/bash
#SBATCH --job-name=v20_oversample_noslot_d64_dr0p3_a2_s2
...
cd "${PROJECT_DIR}/src"
python train.py --config "${PROJECT_DIR}/configs/sweep_v20_oversample/v20_oversample_noslot_d64_dr0p3_a2_s2.yaml" 2>&1

# Evaluation
SAVE_DIR=$(python -c "import yaml; c=yaml.safe_load(open('${PROJECT_DIR}/configs/sweep_v20_oversample/v20_oversample_noslot_d64_dr0p3_a2_s2.yaml')); print(c.get('save_dir', '../checkpoints'))")
