#!/bin/bash
#SBATCH --job-name=v20_oversample_slots_d64_dr0p2_a0p25_s3
...
cd "${PROJECT_DIR}/src"
python train.py --config "${PROJECT_DIR}/configs/sweep_v20_oversample/v20_oversample_slots_d64_dr0p2_a0p25_s3.yaml" 2>&1

# Evaluation
SAVE_DIR=$(python -c "import yaml; c=yaml.safe_load(open('${PROJECT_DIR}/configs/sweep_v20_oversample/v20_oversample_slots_d64_dr0p2_a0p25_s3.yaml')); print(c.get('save_dir', '../checkpoints'))")
